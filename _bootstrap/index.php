...
if (!createObject('modNamespace',array(
    'name' => 'commerce_allordersview',
    'path' => $componentPath.'/core/components/commerce_allordersview/',
    'assets_path' => $componentPath.'/assets/components/commerce_allordersview/',
),'name', false)) {
    echo "Error creating namespace commerce_allordersview.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_allordersview.core_path',
    'value' => $componentPath.'/core/components/commerce_allordersview/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_allordersview',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_allordersview.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_allordersview.assets_path',
    'value' => $componentPath.'/assets/components/commerce_allordersview/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_allordersview',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_allordersview.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_allordersview/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_allordersview.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_allordersview',
    'area' => 'Paths',
    ...
    echo "Error creating commerce_allordersview.assets_url setting.\n";
}
...
foreach ($settings as $key => $opts) {
    ...
    if (!createObject('modSystemSetting', array(
        'key' => 'commerce_allordersview.' . $key,
        'value' => $opts['value'],
        'xtype' => $xtype,
        'namespace' => 'commerce_allordersview',
        'area' => $opts['area'],
        ...
        echo "Error creating commerce_allordersview.".$key." setting.\n";
    }
}
...
include $componentPath . '/core/components/commerce_allordersview/vendor/autoload.php';

// Grab the path to our namespaced files
$modulePath = $componentPath . '/core/components/commerce_allordersview/src/Modules/';

// Instruct Commerce to load modules from our directory, providing the base namespace and module path twice
$commerce->loadModulesFromDirectory($modulePath, 'PoconoSewVac\\AllOrdersView\\Modules\\', $modulePath);
